...
import { calculateStatus } from '../../utils/helper';
...
class Game extends Component {
    ...
    handleClick(xLocation, yLocation) {
        ...
        if (calculateStatus(squares, current.xLocation, current.yLocation).status || squares[xLocation][yLocation]) {
            return;
        }
    ...
    render() {
        ...
        const gameCondition = calculateStatus(current.squares, current.xLocation, current.yLocation);
            ...
            <div className='game'>
                <div className='game-board'>
                    <Board
                        ...
                        onClick={(xLocation, yLocation) => this.handleClick(xLocation, yLocation)}
